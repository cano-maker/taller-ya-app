...
export const workshops = [
    ...
    { id: 3, name: 'Frenos y Lujos La 80', rating: 4.2, services: ['Frenos', 'Suspensión', 'Alineación'], address: 'Av. 80 # 30-15, Belén', image: 'https://images.unsplash.com/photo-1553854314-37b5f8336c6c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80', description: 'Especialistas en sistemas de frenos y suspensión. La seguridad de tu vehículo es nuestra prioridad.', gallery: [], reviews: [] },
    { id: 4, name: 'Taller de Confianza', rating: 5.0, services: ['Mecánica General', 'Eléctrico', 'Diagnóstico'], address: 'Cl. 34 # 65-21, Laureles', image: 'https://images.unsplash.com/photo-1517524206127-48bbd363f369?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80', description: 'Servicio honesto y de alta calidad. Usamos partes originales y garantizamos nuestro trabajo.', gallery: [], reviews: [{user: 'Juan V.', rating: 5, comment: 'El mejor taller de Medellín, sin duda.'}] },
];
